...
const articles = [
  ...
  },
  {
    ...
    excerpt: "Tips menyusun perjanjian kerjasama yang melindungi hak Anda and mencegah sengketa di kemudian hari.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Hak-hak konsumen yang wajib diketahui dalam transaksi online and langkah hukum jika dirugikan.",
    content: `
      ...
      - Hak atas informasi yang benar, jelas, and jujur mengenai kondisi barang/jasa.
      - Hak untuk mendapatkan keamanan and keselamatan dalam mengonsumsi barang/jasa.
      - Hak untuk didengar pendapat and keluhannya.
      - Hak untuk mendapatkan kompensasi atau ganti rugi jika barang yang diterima tidak sesuai.

      Jika Anda merasa dirugikan dalam transaksi digital, simpan semua bukti percakapan and bukti pembayaran. Anda dapat melapor ke Badan Penyelesaian Sengketa Konsumen (BPSK) atau menggunakan fitur aduan yang disediakan oleh platform marketplace.
    `,
    date: "10 Sep 2025",
    category: "Edukasi",
  ...
  },
  {
    ...
    excerpt: "Membedah hukum waris di Indonesia: Siapa yang berhak and bagaimana pembagiannya secara adil.",
    content: `
      Hukum waris di Indonesia memiliki dualisme, yaitu Hukum Waris Islam and Hukum Waris Perdata (KUHPerdata). Pemilihan hukum yang berlaku tergantung pada keyakinan and kesepakatan keluarga.
