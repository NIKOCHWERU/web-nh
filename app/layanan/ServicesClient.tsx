        ...
        <div className="pt-20">
            ...
            <section className="bg-navy text-white py-20 relative overflow-hidden">
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    >
                        {t('nav.services').split(' ')[0]} <span className="text-gold">{t('nav.services').split(' ')[1] || t('about_page.title_gold')}</span>
                    </motion.h1>
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
            ...
            <section className="py-24 bg-navy text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    <h2 className="text-3xl md:text-4xl font-bold mb-8 uppercase tracking-wider">{t('services.cta_custom_title')}</h2>
                    <p className="text-gray-400 max-w-2xl mx-auto mb-12 text-lg">
                        {t('services.cta_custom_desc')}
                    </p>
                    <Link href="/#contact" className="bg-gold text-navy px-12 py-5 rounded-full font-bold hover:bg-opacity-90 transition duration-300 inline-flex items-center gap-3 uppercase tracking-widest shadow-2xl">
                        {t('hero.cta_consult')} <ArrowRight size={20} />
                    </Link>
                </div>
            </section>
        </div>
