        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="relative h-[60vh] overflow-hidden">
                <motion.div style={{ y }} className="absolute inset-0">
                    <div className={`w-full h-full ${service.color} opacity-90`}></div>
                ...
                >
                    <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100">
                        <div className="prose prose-lg max-w-none text-gray-600 prose-headings:text-navy prose-headings:font-serif prose-a:text-gold hover:prose-a:text-navy">
                            {/* Render translation content safely if it exists */}
                            <div dangerouslySetInnerHTML={{ __html: t(`services.${slug}.content`) }} />
                        </div>
                    </div>
                </motion.div>
            </div>
